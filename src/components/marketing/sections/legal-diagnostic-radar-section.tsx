    ...
    <section className="border-y border-border bg-secondary/45 px-4 py-16 sm:px-6 md:py-20">
      <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[0.82fr_1.18fr] lg:items-center">
        <div>
          <SectionReveal>
            <SectionHeading
              ...
              description="Evaluamos áreas clave de la operación para detectar dispersión, cuellos de botella y oportunidades de automatización gradual. El objetivo es definir qué ordenar, qué centralizar y qué medir primero."
            />
          </SectionReveal>
        ...
        <SectionReveal variant="scale" delay={120}>
          <div className="rounded-lg border border-border bg-card p-4 shadow-[0_24px_80px_-62px_var(--primary)] sm:p-6">
            <OperationalRadarChart axes={radarAxes} />
